...
class AddTeaViewModelFactory(
    ...
    companion object {
        ...
        fun createFactory(activity: Activity): AddTeaViewModelFactory {
            val context = activity.applicationContext
                    ?: throw IllegalStateException("Not yet attached to Application")

            return AddTeaViewModelFactory(DataRepository.getInstance(context))
        }
    }
}
